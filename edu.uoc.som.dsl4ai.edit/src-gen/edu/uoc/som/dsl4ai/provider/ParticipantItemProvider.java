...
/**
 * This is the item provider adapter for a {@link edu.uoc.som.dsl4ai.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addParticipationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Participant_participation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Participant_participation_feature",
								"_UI_Participant_type"),
						Dsl4aiPackage.Literals.PARTICIPANT__PARTICIPATION, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Participant_role_feature",
								"_UI_Participant_type"),
						Dsl4aiPackage.Literals.PARTICIPANT__ROLE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		ParticipationKind labelValue = ((Participant) object).getParticipation();
