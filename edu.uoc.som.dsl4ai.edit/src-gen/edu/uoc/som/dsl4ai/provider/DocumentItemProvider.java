...
/**
 * This is the item provider adapter for a {@link edu.uoc.som.dsl4ai.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider extends ArtifactItemProvider {
	/**
	...
	protected void addTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Document_template_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Document_template_feature",
								"_UI_Document_type"),
						Dsl4aiPackage.Literals.DOCUMENT__TEMPLATE, true, false, true, null, null, null));
	}
